...
public class Reserva {
    ...
    /**
     * Calcula el coste total de la reserva en función de: 
     * - el tipo de habitación (DOBLE o SUITE).
     * - La duración de la estancia (número de noches).
     * - Si se ha solicitado una cama supletoria.
     * Además, aplica un descuento del 10% si la estancia es superior a 7 noches.
     */
